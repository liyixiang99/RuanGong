...
var mui = function(a, b) {
	...
	i.uuid = 0, i.data = {}, i.extend = function() {
		...
		var b = !!a && "length" in a && a.length,
			c = i.type(a);
		return "function" !== c && !i.isWindow(a) && ("array" === c || 0 === b || "number" == typeof b && b > 0 && b - 1 in
			a)
		...
		return i.extend(function() {
			!f || g >= f && i.now() - g > b || g < f && i.now() - f > 8 * b ? d.apply(this, arguments) : (e && e.cancel(), e =
		...
		j = function(b, d, e, f) {
			return function(e) {
				...
				j = null, e = g(e), a.each(h, function(b, c) {
					i = c.element;
					var f = i.tagName;
					if ("tap" === d && "INPUT" !== f && "TEXTAREA" !== f && "SELECT" !== f && (e.preventDefault(), e.detail && e.detail
							.gesture && e.detail.gesture.preventDefault()), a.each(c.handlers, function(b, c) {
	...
	a.fn.on = function(b, d, e) {
		return this.each(function() {
			...
			if (a.isEmptyObject(m) && (g = !0), (m[d] || (m[d] = [])).push(e), g) {
				...
				n || (n = []);
				var o = j(f, b, d, e);
				n.push(o), o.i = n.length - 1, o.type = b, i[h(f)] = n, f.addEventListener(b, o), "tap" === b && f.addEventListener(
					"click",
					function(a) {
						if (a.target) {
	...
	a.targets = {}, a.targetHandles = [], a.registerTarget = function(b) {
		...
		for (var d = b.target, e = {}; d && d !== c; d = d.parentNode) {
			...
			if (a.each(a.targetHandles, function(c, g) {
					var h = g.name;
					f || e[h] || !g.hasOwnProperty("handle") ? e[h] || !1 !== g.isReset && (a.targets[h] = !1) : (a.targets[h] = g.handle(
						b, d), a.targets[h] && (e[h] = !0, !0 !== g.isContinue && (f = !0)))
				}), f) break
		}
...
function() {
	...
	function(a, b, c) {
		if ((a.os.android || a.os.ios) && !b.FastClick) {
			...
			b.addEventListener("tap", e), b.addEventListener("doubletap", e), b.addEventListener("click", function(b) {
				if (a.targets.click && !b.forwardedTouchEvent) return b.stopImmediatePropagation ? b.stopImmediatePropagation() :
					b.propagationStopped = !0, b.stopPropagation(), b.preventDefault(), !1
			}, !0)
		}
	}(mui, window, "click"),
	function(a, b) {
			...
			if (a.os.ios) {
				...
				b.addEventListener("focusin", function(d) {
					if (!(a.os.plus && window.plus && plus.webview.currentWebview().children().length > 0)) {
						var e = d.target;
						if (e.tagName && ("TEXTAREA" === e.tagName || "INPUT" === e.tagName && ("text" === e.type || "search" === e.type ||
								"number" === e.type))) {
							if (e.disabled || e.readOnly) return;
							b.body.classList.add(c);
							for (var f = !1; e && e !== b; e = e.parentNode) {
								var g = e.classList;
								if (g && g.contains("mui-bar-tab") || g.contains("mui-bar-footer") || g.contains("mui-bar-footer-secondary") ||
	...
	function(a, b) {
		...
		var c = Math.round,
			...
			y = function(b, c) {
				...
				if (e !== a.EVENT_START && e !== a.EVENT_MOVE || 1 !== d.length) {
					...
					for (h = 0; h < i.length;) w[i[h].identifier] && g.push(i[h]), e !== a.EVENT_END && e !== a.EVENT_CANCEL || delete w[
						i[h].identifier], h++;
			...
			z = function(b) {
				...
				y(b, c) && (t(c), m(b, c), a.gestures.session.prevTouch = c, b.type !== a.EVENT_END || a.isTouchable || (a.gestures
					.touch = a.gestures.session = {}))
			},
			A = function() {
				var a = !1;
				try {
		...
		b.addEventListener(a.EVENT_START, z), b.addEventListener(a.EVENT_MOVE, z, !!A && {
			passive: !1,
			capture: !1
		}), b.addEventListener(a.EVENT_END, z), b.addEventListener(a.EVENT_CANCEL, z), b.addEventListener(a.EVENT_CLICK,
			function(b) {
				...
				case a.EVENT_MOVE:
					if (a.options.gestureConfig.pinch) {
						...
						var g = d.scale,
							...
							j = 1e-12;
						g > i ? (i = g - j, a.trigger(f.target, b + "out", d)) : g < i && (i = g + j, a.trigger(f.target, b + "in", d)),
		...
		a.openWindow = function(b, f, g) {
			...
			if (window.plus) {
				...
				var h, i, j = g.params || {},
					k = null,
					l = null;
				if (a.webviews[f] ? (l = a.webviews[f], plus.webview.getWebviewById(f) && (k = l.webview)) : !0 !== g.createNew &&
			...
			if (window.plus) {
				var i, j, k = b.params || {},
					l = null,
					m = null;
				if (a.webviews[h] ? (m = a.webviews[h], plus.webview.getWebviewById(h) && (l = m.webview)) : !0 !== b.createNew &&
			...
			if (window.plus) {
				var d, e = b.id || b.url;
				if (b.preload) {
					a.webviews[e] && a.webviews[e].webview.getURL() ? d = a.webviews[e].webview : (!0 !== b.createNew && (d = plus.webview
				...
				} else !1 !== c && (d = plus.webview.create(b.url, e, a.windowOptions(b.styles), b.extras), b.subpages && a.each(b
					.subpages,
					function(b, c) {
						var e = c.id || c.url,
	...
	function(a, b, c) {
		...
		a.ajax = function(d, e) {
			...
			var m = f.accepts[h && h.toLowerCase()],
				...
				t = f.xhr(f);
			"file:" === location.protocol && a.os.ios && b.webkit && b.webkit.messageHandlers && !(t instanceof plus.net.XMLHttpRequest) &&
				console.error("当前运行环境为WKWebview，需在plusReady事件触发后再调用mui.ajax，否则可能会执行失败或报Script error的错误");
			var u, v = t.setRequestHeader;
			if (r("X-Requested-With", "XMLHttpRequest"), r("Accept", m || "*/*"), (m = f.mimeType || m) && (m.indexOf(",") > -1 &&
					(m = m.split(",", 2)[0]), t.overrideMimeType && t.overrideMimeType(m)), (f.contentType || !1 !== f.contentType &&
					f.data && "GET" !== f.type.toUpperCase()) && r("Content-Type", f.contentType ||
			...
			if (t.setRequestHeader = r, t.onreadystatechange = function() {
					if (4 === t.readyState) {
						...
						if (t.status >= 200 && t.status < 300 || 304 === t.status || 0 === t.status && d && t.responseText) {
							...
							try {
								"script" === h ? (0, eval)(b) : "xml" === h ? b = t.responseXML : "json" === h && (b = i.test(b) ? null : a.parseJSON(
									b))
							} catch (a) {
								c = a
							}
		...
		var e = "mui-scroll",
			...
			l = a.Class.extend({
				...
				_gotoPage: function(a) {
					...
					for (var b = 0, c = this.snaps.length; b < c; b++) b === a ? this.snaps[b].classList.add(j) : this.snaps[b].classList
						.remove(j);
				...
				_getDirectionByAngle: function(a) {
					return a < -80 && a > -100 ? "up" : a >= 80 && a < 100 ? "down" : a >= 170 || a <= -170 ? "left" : a >= -35 && a <=
						10 ? "right" : null
				},
				_drag: function(c) {
					var d = c.detail;
					...
					if (this.moved) {
						...
						if (this._clearRequestAnimationFrame(), "dragend" !== b.type || !c.flick) {
							...
							if (this.isInTransition = !1, !this.resetPosition(this.options.bounceTime)) {
								...
								var f = 0,
									g = "";
								if (this.options.momentum && c.flickTime < 300 && (momentumX = this.hasHorizontalScroll ? this._momentum(this
											.x, c.flickDistanceX, c.flickTime, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options
											.deceleration) : {
											destination: d,
											duration: 0
										...
										this.isInTransition = !0), d != this.x || e != this.y) return (d > 0 || d < this.maxScrollX || e > 0 || e <
									this.maxScrollY) && (g = k.quadratic), void this.scrollTo(d, e, f, g);
				...
				_updateTranslate: function() {
					var a = this;
					a.x === a.lastX && a.y === a.lastY || a.setTranslate(a.x, a.y), a.requestAnimationFrame = requestAnimationFrame(
						function() {
							a._updateTranslate()
						})
				},
				...
				_momentum: function(a, b, c, e, f, g) {
					...
					return g = g === d ? 6e-4 : g, h = a + j * j / (2 * g) * (b < 0 ? -1 : 1), i = j / g, h < e ? (h = f ? e - f /
				...
				resetPosition: function(a) {
					...
					return a = a || 0, !this.hasHorizontalScroll || this.x > 0 ? b = 0 : this.x < this.maxScrollX && (b = this.maxScrollX),
						!this.hasVerticalScroll || this.y > 0 ? c = 0 : this.y < this.maxScrollY && (c = this.maxScrollY), (b != this.x ||
							c != this.y) && (this.scrollTo(b, c, a, this.options.scrollEasing), !0)
				},
				_reInit: function() {
	...
	function(a, b, c, d) {
		...
		a.fn.pullRefresh = function(b) {
			if (1 === this.length) {
				...
				return !(!e && void 0 === b) && (b = b || {}, e ? d = a.data[e] : (e = ++a.uuid, a.data[e] = d = new g(c, b), c.setAttribute(
						"data-pullrefresh", e)), b.down && b.down.auto ? d.pulldownLoading(b.down.autoY) : b.up && b.up.auto && d.pullupLoading(),
					d)
			}
		}
	}(mui, window, document),
			...
			l = a.Slider = a.Scroll.extend({
						...
						if (m) {
							...
							if (n.length > 0)
								...
								if (o) o.innerText = d.slideNumber + 1;
									...
									for (var p = m.querySelectorAll(".mui-control-item"), g = 0, h = p.length; g < h; g++) p[g].classList[g ===
				...
				_initSnap: function() {
					if (this.scrollerWidth = this.itemLength * this.scrollerWidth, this.maxScrollX = Math.min(this.wrapperWidth -
						...
						void 0 === this.lastSlideNumber ? this.slideNumber : this.lastSlideNumber;
					else {
						var a = this.pages[this.loop ? 1 : 0];
						if (!(a = a || this.pages[0])) return;
						this.currentPage = a[0], this.slideNumber = 0, this.lastSlideNumber = void 0 === this.lastSlideNumber ? 0 :
				...
				_getPage: function(a, b) {
					return this.loop ? a > this.itemLength - (b ? 2 : 3) ? (a = 1, time = 0) : a < (b ? -1 : 0) ? (a = this.itemLength -
						2, time = 0) : a += 1 : (b || (a > this.itemLength - 1 ? (a = 0, time = 0) : a < 0 && (a = this.itemLength - 1,
				...
				setTranslate: function(a, b) {
					this._super(a, b), this.progressBar && (this.progressBarStyle.webkitTransform = this._getTranslateStr(-a * (this
						.progressBarWidth / this.wrapperWidth), 0))
				},
				resetPosition: function(a) {
		...
		a.fn.slider = function(b) {
			...
			return this.each(function() {
				...
				if (this.classList.contains(c) || (e = this.querySelector("." + c)), e && e.querySelector(j)) {
					...
					f ? (d = a.data[f]) && b && d.refresh(b) : (f = ++a.uuid, a.data[f] = d = new l(e, b), e.setAttribute(
						"data-slider", f))
				}
			}), d
		}, a.ready(function() {
		...
		a.os.plus && a.plusReady(function() {
			if (!1 !== window.__NWin_Enable__) {
				var c = "mui-visibility",
					...
					j = a.Class.extend({
						...
						beginPullup: function(a) {
							var b = this;
							b.isLoading || (b.isLoading = !0, !1 !== b.pulldown ? b._initPullupRefresh() : this.pullPocket.classList.add(
								e), setTimeout(function() {
								b.pullLoading.classList.add(c), b.pullLoading.classList.remove(d), b.pullCaption.innerHTML = "", b.pullCaption
									.className = f + " " + h, b.pullCaption.innerHTML = b.options.up.contentrefresh, (a = a || b.options.up
										.callback) && a.call(b)
							}, 300))
						},
						...
						endPullup: function(a) {
							var e = this;
							e.pullLoading && (e.pullLoading.classList.remove(c), e.pullLoading.classList.add(d), e.isLoading = !1, a ?
								(e.finished = !0, e.pullCaption.className = f + " " + i, e.pullCaption.innerHTML = e.options.up.contentnomore,
									b.removeEventListener("plusscrollbottom", e), window.removeEventListener("dragup", e)) : (e.pullCaption.className =
									f + " " + g, e.pullCaption.innerHTML = e.options.up.contentdown))
						},
						endPullupToRefresh: function(a) {
							this.endPullup(a)
						},
						...
						disablePullupToRefresh: function() {
							this._initPullupRefresh(), this.bottomPocket.className = "mui-pull-bottom-pocket " + d, window.removeEventListener(
								"dragup", this)
						},
						enablePullupToRefresh: function() {
							this._initPullupRefresh(), this.bottomPocket.classList.remove(d), this.pullCaption.className = f + " " + g,
				...
				a.fn.pullRefresh_native = function(c) {
					var d;
					0 === this.length ? (d = b.createElement("div"), d.className = "mui-content", b.body.appendChild(d)) : d = this[
						0];
					var e = c;
					c = c || {}, "string" == typeof c && (c = a.parseJSON(c)), !c.webviewId && (c.webviewId = plus.webview.currentWebview()
						.id || plus.webview.currentWebview().getURL());
					var f = null,
						g = c.webviewId && c.webviewId.replace(/\//g, "_"),
						h = d.getAttribute("data-pullrefresh-plus-" + g);
					return !(!h && void 0 === e) && (h ? f = a.data[h] : (h = ++a.uuid, d.setAttribute("data-pullrefresh-plus-" + g,
							h), b.body.classList.add("mui-plus-pullrefresh"), a.data[h] = f = new j(d, c)), c.down && c.down.auto ? f.beginPulldown() :
						c.up && c.up.auto && f.beginPullup(), f)
				}
			}
		})
	}(mui, document),
			...
			m = a.Class.extend({
							...
							if (this.isDragging) {
								...
								if (this.slideIn) {
									if (e = f >= 0 ? this.offCanvasRightWidth && f / this.offCanvasRightWidth || 0 : this.offCanvasLeftWidth &&
										f / this.offCanvasLeftWidth || 0, "right" === d && e <= 0 && (e >= -.5 || c.swipe) ? this.openPercentage(
											100) : "right" === d && e > 0 && (e >= .5 || c.swipe) ? this.openPercentage(0) : "right" === d && e <= -.5 ?
										this.openPercentage(0) : "right" === d && e > 0 && e <= .5 ? this.openPercentage(-100) : "left" === d && e >=
										0 && (e <= .5 || c.swipe) ? this.openPercentage(-100) : "left" === d && e < 0 && (e <= -.5 || c.swipe) ?
										this.openPercentage(0) : "left" === d && e >= .5 ? this.openPercentage(0) : "left" === d && e >= -.5 && e <
										0 ? this.openPercentage(100) : this.openPercentage(0), 1 === e || -1 === e || 0 === e) return void this._dispatchEvent()
								} else {
									if (0 === (e = f >= 0 ? this.offCanvasLeftWidth && f / this.offCanvasLeftWidth || 0 : this.offCanvasRightWidth &&
											f / this.offCanvasRightWidth || 0)) return this.openPercentage(0), void this._dispatchEvent();
									"right" === d && e >= 0 && (e >= .5 || c.swipe) ? this.openPercentage(100) : "right" === d && e < 0 && (e >
											-.5 || c.swipe) ? this.openPercentage(0) : "right" === d && e > 0 && e < .5 ? this.openPercentage(0) :
										"right" === d && e < .5 ? this.openPercentage(-100) : "left" === d && e <= 0 && (e <= -.5 || c.swipe) ?
										this.openPercentage(-100) : "left" === d && e > 0 && (e <= .5 || c.swipe) ? this.openPercentage(0) : "left" ===
										d && e < 0 && e >= -.5 ? this.openPercentage(0) : "left" === d && e > .5 ? this.openPercentage(100) : this.openPercentage(
				...
				openPercentage: function(a) {
					...
					this.slideIn ? (this.offCanvasLeft && a >= 0 ? (b = 0 === b ? -1 : 0, this.updateTranslate(this.offCanvasLeftWidth *
						b), this.offCanvasLeft.classList[0 !== a ? "add" : "remove"](j)) : this.offCanvasRight && a <= 0 && (b = 0 ===
						...
						a <= 0 && (this.updateTranslate(this.offCanvasRightWidth * b), this.offCanvasRight.classList[0 !== b ? "add" :
				...
				isShown: function(a) {
					...
					if (this.slideIn) b = "left" === a ? this.classList.contains(j) && this.wrapper.querySelector("." + e + "." + j) :
						...
						b = "right" === a ? this.classList.contains(j) && c < 0 : "left" === a ? this.classList.contains(j) && c > 0 :
				...
				show: function(a) {
					return this._initOffCanvasVisible(), !this.isShown(a) && (a || (a = this.wrapper.querySelector("." + f) ?
			...
			v = function(d, e, h) {
				if (d && e) {
					...
					l + r < p.top - b.pageYOffset ? s = p.top - l - r : l + r < j - (p.top - b.pageYOffset) - o ? (y = "bottom", s = p
						...
						0)), "top" === y || "bottom" === y ? (t = n / 2 + p.left - k / 2, v = t, t < x && (t = x), t + k > i && (t = i -
	...
	function(a, b, c, d, e) {
		var f = "mui-control-item",
			...
			i = "mui-tab-item",
			j = function(a, b) {
				return !(!b.classList || !b.classList.contains(f) && !b.classList.contains(i)) && (b.parentNode && b.parentNode.classList &&
					b.parentNode.classList.contains(g) || a.preventDefault(), b)
			};
		a.registerTarget({
			name: d,
			index: 80,
	...
	function(a, b, c) {
		...
		k.prototype.init = function() {
			...
			this.handle.style.webkitTransitionDuration = this.element.style.webkitTransitionDuration = !1 === b ? "0s" : ".2s",
				c.contains(f) ? (c.remove(f), this.handle.style.webkitTransform = "translate(0,0)") : (c.add(f), this.handle.style
					.webkitTransform = "translate(" + this.handleX + "px,0)"), a.trigger(this.element, "toggle", {
					isActive: this.classList.contains(f)
				})
				...
				if (translateX !== lastTranslateX) {
					if (buttonsRight && buttonsRight.length > 0) {
						...
						for (var a = 0, b = buttonsRight.length; a < b; a++) {
							...
							void 0 === c._buttonOffset && (c._buttonOffset = c.offsetLeft), buttonOffset = c._buttonOffset, E(c, translateX -
					...
					if (buttonsLeft && buttonsLeft.length > 0) {
						...
						for (var a = 0, b = buttonsLeft.length; a < b; a++) {
							var d = buttonsLeft[a];
							void 0 === d._buttonOffset && (d._buttonOffset = sliderActionLeftWidth - d.offsetLeft - d.offsetWidth),
		...
		var F = {
			...
			drag: function(a) {
				if (e) {
					z || (A = sliderActionLeft = sliderActionRight = buttonsLeft = buttonsRight = sliderDirection =
						sliderRequestAnimationFrame = !1, (A = e.querySelector(t)) && (sliderActionLeft = e.querySelector(u),
					...
					var b = a.detail,
						c = b.direction,
						d = b.angle;
					if ("left" === c && (d > 150 || d < -150) ? (buttonsRight || buttonsLeft && isOpened) && (z = !0) : "right" ===
						c && d > -30 && d < 30 && (buttonsLeft || buttonsRight && isOpened) && (z = !0), z) {
						...
						if (isOpened && ("right" === openedActions ? f -= sliderActionRightWidth : f += sliderActionLeftWidth), f > 0 &&
							!buttonsLeft || f < 0 && !buttonsRight) {
							if (!isOpened) return;
							f = 0
						}
						f < 0 ? sliderDirection = "toLeft" : f > 0 ? sliderDirection = "toRight" : sliderDirection || (sliderDirection =
			...
			dragend: function(b) {
				if (z) {
					...
					(c.swipe || Math.abs(translateX) > f / 2) && (isOpened ? "left" === c.direction && "right" === openedActions ? d =
						"open" : "right" === c.direction && "left" === openedActions && (d = "open") : d = "open"), e.classList.add(s);
					var g;
					if ("open" === d) {
						...
						if (E(A, i), void 0 !== (g = "toLeft" === sliderDirection ? buttonsRight : buttonsLeft)) {
							...
							j.parentNode.classList.add(h), e.classList.add(h), isOpened || a.trigger(e, "toLeft" === sliderDirection ?
					...
					if (buttonsLeft && buttonsLeft.length > 0 && buttonsLeft !== g)
						for (var k = 0, m = buttonsLeft.length; k < m; k++) {
							var n = buttonsLeft[k];
							l = n._buttonOffset, void 0 === l && (n._buttonOffset = sliderActionLeftWidth - n.offsetLeft - n.offsetWidth),
								E(n, l)
						}
			...
			if (b) {
				...
				if (!d.contains(h)) {
					...
					if (e) {
						...
						for (var f, g = e.querySelectorAll(x), i = e.offsetWidth, j = "right" === c ? -i : i, k = g.length, l = 0; l < k; l++)
	...
	function(a, b, c) {
		var d = "mui-popup",
			...
			t = function(a) {
				for (var b = a.length, c = [], d = 0; d < b; d++) c.push('<span class="' + m + (d === b - 1 ? " " + n : "") + '">' +
					a[d] + "</span>");
					...
					n = {
						...
						close: function(a, b) {
							if (h) {
								...
								!1 !== b ? (h.classList.remove(f), h.classList.add(g)) : i(), p.pop(), p.length ? p[p.length - 1].show(b) : q.classList
									.remove(o)
							}
						}
					},
			...
			v = function(b, c, d, e, f) {
				if (void 0 !== b) return "function" == typeof c ? (e = c, f = d, c = null, d = null) : "function" == typeof d && (f =
					e, e = d, d = null), a.os.plus && "div" !== f ? plus.nativeUI.alert(b, e, c || "提示", d || "确定") : u(s(b, c ||
					"提示") + t([d || "确定"]), e)
			},
			w = function(b, c, d, e, f) {
				if (void 0 !== b) return "function" == typeof c ? (e = c, f = d, c = null, d = null) : "function" == typeof d && (f =
					e, e = d, d = null), a.os.plus && "div" !== f ? plus.nativeUI.confirm(b, e, c, d || ["取消", "确认"]) : u(s(b, c ||
					"提示") + t(d || ["取消", "确认"]), e)
			},
			x = function(b, c, d, e, f, g) {
				if (void 0 !== b) return "function" == typeof c ? (f = c, g = d, c = null, d = null, e = null) : "function" ==
					typeof d ? (f = d, g = e, d = null, e = null) : "function" == typeof e && (g = f, f = e, e = null), a.os.plus &&
					"div" !== g ? plus.nativeUI.prompt(b, f, d || "提示", c, e || ["取消", "确认"]) : u(s(b, d || "提示", r(c)) + t(e || [
						"取消", "确认"
					]), f)
			},
			y = function() {
			...
			i = function(h, i, j) {
				if ("number" == typeof h && (j = i, i = h, h = "body"), h = a(h || "body"), 0 !== h.length) {
					...
					if (h.classList.contains(c)) l = h;
						...
						l ? l.classList.add(d) : (l = b.createElement("span"), l.className = c + " " + d + (void 0 !== i ? "" : " " + f) +
							(j ? " " + c + "-" + j : ""), void 0 !== i && (l.innerHTML = "<span></span>"), h.appendChild(l))
					}
					return i && k(h, i), l
				}
			},
	...
	function(a, b, c) {
		var d = "mui-icon",
			...
			s = function(a, b) {
				this.element = a, this.options = b || {
						actions: "clear"
					}, ~this.options.actions.indexOf("slider") ? (this.sliderActionClass = j + " " + k, this.sliderActionSelector = q) :
					(~this.options.actions.indexOf("clear") && (this.clearActionClass = d + " " + e + " " + k, this.clearActionSelector =
							m), ~this.options.actions.indexOf("speech") && (this.speechActionClass = d + " " + f, this.speechActionSelector =
							n), ~this.options.actions.indexOf("search") && (this.searchActionClass = i, this.searchActionSelector = p), ~
						this.options.actions.indexOf("password") && (this.passwordActionClass = d + " " + g, this.passwordActionSelector =
							o)), this.init()
			};
		s.prototype.init = function() {
			...
			if (!f) {
				...
				f.className = b, b === this.searchActionClass && (f.innerHTML = '<span class="' + d +
					' mui-icon-search"></span><span>' + this.element.getAttribute("placeholder") + "</span>", this.element.setAttribute(
						"placeholder", ""), this.element.value.trim() && a.classList.add("mui-active")), a.insertBefore(f, this.element
					.nextSibling)
			}
			return f
		...
		f.prototype.initEvent = function() {
			...
			return this.each(function() {
				...
				if (!d) {
					...
					null !== e && void 0 === a.top && (a.top = e), null !== g && void 0 === a.offset && (a.offset = g), null !== h &&
						void 0 === a.duration && (a.duration = h), null !== i && void 0 === a.scrollby && (a.scrollby = document.querySelector(
							i) || b), d = this.mui_plugin_transparent = new f(this, a)
				}
				c.push(d)
			}), 1 === c.length ? c[0] : c
		}, a.ready(function() {
		...
		var b = "ontouchstart" in document,
			...
			h = a.Numbox = a.Class.extend({
				init: function(b, c) {
					...
					d.holder = b, c = c || {}, c.step = parseInt(c.step || 1), d.options = c, d.input = a.qsa(g, d.holder)[0], d.plus =
						a.qsa(e, d.holder)[0], d.minus = a.qsa(f, d.holder)[0], d.checkValue(), d.initEvent()
				},
				initEvent: function() {
					var b = this;
				...
				if (!b.numbox)
					if (d) b.numbox = new h(b, d);
						...
						d.step = b.getAttribute("data-numbox-step") || d.step, d.min = b.getAttribute("data-numbox-min") || d.min, d.max =
							b.getAttribute("data-numbox-max") || d.max, b.numbox = new h(b, d)
					}
